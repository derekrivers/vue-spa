...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router___default.a({
  ...
  routes: [{ path: '/login', component: __WEBPACK_IMPORTED_MODULE_3__theme_Login_vue__["a" /* default */] }, { path: '/category/:id', name: 'category', component: __WEBPACK_IMPORTED_MODULE_2__theme_Category_vue__["a" /* default */] }, { path: '*', component: __WEBPACK_IMPORTED_MODULE_4__theme_NotFound_vue__["a" /* default */] }]
});
...
var __vue_scopeId__ = null
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "48ed34d4"
var Component = normalizeComponent(
  __vue_script__,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_service__ = __webpack_require__(5);
...
var actions = {
  updateCategory: function updateCategory(context, categoryId) {
    return __WEBPACK_IMPORTED_MODULE_0__app_service__["a" /* default */].getPosts(categoryId).then(function (data) {
